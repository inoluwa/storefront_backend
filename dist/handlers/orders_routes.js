...
var getCurrentuserOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, orderByUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = Number(req.params.id);
                return [4 /*yield*/, store.currentUserOrder(userId)];
            case 1:
                orderByUser = _a.sent();
...
var orderRoutes = function (app) {
    app.get('/orders', authRouteGuard_1.default, allOrders);
    app.get('/current-user/:id', authRouteGuard_1.default, getCurrentuserOrder);
    app.post('/create-order', authRouteGuard_1.default, create);
};
